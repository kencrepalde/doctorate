...
#Without spaces and special characters - I had made this for medicines linkage
...
#first, it's necessary to change dt type (need to be date class)
...
#as.data.frame was added to avoid bug Unknown or uninitialised column: `varible`"
...
#medlist is a bank with all regimen and categorizin by medicine, not only regigen
...
#remember, this week format start in sunday
